...
--%>					
			...
			<ul class="social_icons">
				<li><a href="#"><img src="/images/icon-rss.png" alt="RSS feed" /></a></li>
				<li><a href="#"><img src="/images/icon-mail.png" alt="eMail" /></a></li>
		...
		<div >
			<div style="float: left; width: 90px; font-weight: bold;">AVAILABLE COACHES: </div>
			<div style="float: left; width: 75%; text-align: left;">
				...
				<a style="color:#0404B4"  href="${pageContext.request.contextPath}/public/landing-corporate-coaches">CORPORATE COACHES</a> | 
				<a style="color:#0404B4"  href="${pageContext.request.contextPath}/public/landing-family-coaches">FAMILY COACHES</a> | 
				<a style="color:#0404B4"  href="${pageContext.request.contextPath}/public/landing-finance-money-coaches">FINANCE / MONEY COACHES</a> | 
				<a style="color:#0404B4"  href="${pageContext.request.contextPath}/public/landing-fitness-coaches">FITNESS COACHES</a> | 
				<a style="color:#0404B4"  href="${pageContext.request.contextPath}/public/landing-nutrition-coaches">NUTRITION COACHES</a> | 
				<a style="color:#0404B4"  href="${pageContext.request.contextPath}/public/landing-life-coaches">LIFE COACHES</a> | 
				<a style="color:#0404B4"  href="${pageContext.request.contextPath}/public/landing-relationship-coaches">RELATIONSHIP COACHES</a>
			</div>
