...
&gt;&gt;<a href="${pageContext.request.contextPath}/tutor/public/coachSelection?BREADCRUMB=y">Coach List</a>
&gt;&gt;<a href="${pageContext.request.contextPath}/tutor/public/profile?BREADCRUMB=y">Coach Profile</a><br><br>
...
--%>
				...
				<tr>
					<td>
	                	By clicking Submit Payment Information below, you agree to our <a style="font-size:12px;color:#0404B4" href="${pageContext.request.contextPath}/tutor/terms-of-use">Terms of Service</a> and <a style="font-size:12px;color:#0404B4" href="${pageContext.request.contextPath}/tutor/privacy-policy">Privacy Policy</a> 
					</td>
				</tr>
