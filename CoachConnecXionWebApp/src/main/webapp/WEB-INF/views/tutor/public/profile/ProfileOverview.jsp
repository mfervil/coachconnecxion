...
<c:if test="${not empty profileInfo.getVideo_url()}">
		...
		-->
		 ...
		 <td >
							...
							<%--
							<tr>
								<td style="font-size: 12px; text-align: left; vertical-align: top;"><b>Country:</b> USA &nbsp; <b>Language:</b> English <br><b>Clients:</b> <c:out value="${totalClients}"></c:out> &nbsp; <b>Average Rating:</b> <%@ include file="/WEB-INF/views/tutor/common/average_rating.jsp" %><br><b>Highest Position Held:</b> VP Of Information Technology
								</td>
							</tr>
							 --%>
							</table>
