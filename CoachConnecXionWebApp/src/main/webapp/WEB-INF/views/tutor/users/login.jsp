    ...
    <div class="pageWrapper">
        ...
        <div class="signUpForm">
            <form action="<c:url value="/j_spring_security_check"/>" method="post">
                ...
                <br>
                <div>
                	By clicking Sign In below, you agree to our <a style="font-size:12px;color:#0404B4" href="${pageContext.request.contextPath}/tutor/terms-of-use">Terms of Service</a> and <a style="font-size:12px;color:#0404B4" href="${pageContext.request.contextPath}/tutor/privacy-policy">Privacy Policy</a> 
                </div>
