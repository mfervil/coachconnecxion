...
<div id="content">
    <div class="pageWrapper">
        ...
        <form:form id="userCreate" action="${submitUrl}" method="post" modelAttribute="user" class="noValidate">
            ...
            --%>
                <div>
                	By clicking Register below, you agree to our <a style="font-size:12px;color:#0404B4" href="${pageContext.request.contextPath}/tutor/terms-of-use">Terms of Service</a> and <a style="font-size:12px;color:#0404B4" href="${pageContext.request.contextPath}/tutor/privacy-policy">Privacy Policy</a> 
                </div>
