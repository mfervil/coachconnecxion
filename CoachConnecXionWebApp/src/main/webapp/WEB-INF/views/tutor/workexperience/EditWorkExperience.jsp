...
<head>
	<title>Edit Coach or Trainer work Experience</title>
					...
					<c:choose>
						<c:when test="${not empty successMessage}">
							<div id='myDialog'>
								...
								<br> Click&nbsp;&nbsp;<a
									href="experienceEdit?id=${jobHistoryAttribute.id}"
									style="font-size: 14px;text-decoration: underline;color:blue;">here</a>&nbsp;&nbsp;To update employer
								again <br>OR <br> Click&nbsp;&nbsp;<a
									href="workexperience" style="font-size: 14px;text-decoration: underline;color:blue;">here</a>&nbsp;&nbsp;To
