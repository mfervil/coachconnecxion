...
<input type="hidden" name="success" id="success" value="${successMessage}"></input>
						...
						<c:when test="${not empty successMessage}">
							<div id='myDialog'>
								<h1 style="font-size: 14px; color: green;">${successMessage}</h1>
								 <br>
								 <br>
								Click&nbsp;&nbsp;<a href="${pageContext.request.contextPath}/tutor/viewOrders" style="font-size: 14px;text-decoration: underline;color:blue;">here</a>&nbsp;&nbsp;To go back to project list.							
	...
	<c:url var="feedbackCommentsUrl"
		value="/feedbackAdd?id=${jobratingDetailId}" />
		...
		<div align="center">
			...
			<table style="width: 900px;">
				<tr>
					...
					<td style=""><form:input type="text" value="${vendorName}" path="vendorName"
							cssStyle="border:none; background:none;font-weight:bold;"
							readonly="true" /></td>
