...
<head>
	<title>Blog listing for personal tutors and those seeking tutoring help</title>
	<meta http-equiv="Content-Type" content="text/html;charset=utf-8" />
	<meta charset="utf-8" />
	<meta name="description" content="News and information for individuals seeking personal tutors and tips and guidance for aspiring tutors as well as the expert tutoring professionals" />
				...
				<td style="width: 730px; padding: 5px;" >
					<table>
						<tr class="blog-page-table-tr">
									...
									<c:forEach items="${blogPostListing}" varStatus="status" var="blogPost">
										...
										<table>
											...
											<tr><td style="text-align: left">
												<a href="${pageContext.request.contextPath}/tutor/update-blog/blogId/${blogPost.blogid}">.</a>
												<a style="color: blue" href="${pageContext.request.contextPath}/tutor/blogview/professional-and-life-coaches/blogref/${blogPost.blogid}/cattitle/${fn:replace(blogPost.coachingcategoryName, ' ', '-')}-${fn:replace(blogPost.blogtitle, ' ', '-')}">More... View / Leave Comments</a>
											</td></tr>
										</table>
							...
							<%@ include file="/WEB-INF/views/tutor/blogview/blogRecents.jsp" %>
							<br>
							<%@ include file="/WEB-INF/views/tutor/blogview/blogArchives.jsp" %>
							<%--
								<a style="color: blue;" href="${pageContext.request.contextPath}/tutor/blogview/recent-personal-coach-blogs"> &nbsp; ** &nbsp; MOST RECENT BLOGS &nbsp; ** &nbsp;</a>
