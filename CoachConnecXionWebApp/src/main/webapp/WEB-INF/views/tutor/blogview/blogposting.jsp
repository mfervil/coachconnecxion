...
<head>
	<title>${blogPost.coachingcategoryName} Tutors ${blogPost.blogtitle}</title>
								...
								<tr>
									<td style="margin-top: 4px; vertical-align: text-top;"> <!-- style="margin-top -->
										...
										<table>
											...
											<tr><td style="text-align: left"><a href="${pageContext.request.contextPath}/tutor/update-blog/blogId/${blogId}">.</a></td></tr>
										</table>
