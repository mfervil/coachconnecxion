...
<%-- END BODY No Side test --%>
	...
	<a href="https://www.coachconnecxion.com">&gt;&gt;Home</a> &gt;&gt;<a href="${pageContext.request.contextPath}/tutor/createuserprofile">User Profile</a><br><br>
...
<c:if test="${sessionScope.newusercreated == '1'}">
	...
	<br><br><b> <span style="font-size: 1.25em; color: rgb(0,0,255); text-decoration: underline;"> <a href="${pageContext.request.contextPath}/tutor/packageAdd">**CLICK HERE TO CREATE YOUR COACHING PACKAGES**</a> </span></b>
</c:if>
<c:if test="${sessionScope.newusercreated != '1'}">
	<br><br><b> <span style="font-size: 1.25em; color: rgb(0,0,255); text-decoration: underline;"> <a href="${pageContext.request.contextPath}/tutor/public/profile?profileId=${profileId}">**CLICK HERE TO VIEW YOUR UPDATED PROFILE**</a> </span></b>
</c:if>
