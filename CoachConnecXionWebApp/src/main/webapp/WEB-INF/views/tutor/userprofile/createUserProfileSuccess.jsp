...
<c:if test="${sessionScope.newusercreated != '1'}">
	<br><br><b> <span style="font-size: 1.25em; color: rgb(0,0,255); text-decoration: underline;"> <a href="${pageContext.request.contextPath}/tutor/public/profile">**CLICK HERE TO VIEW YOUR UPDATED PROFILE**</a> </span></b>
</c:if>
