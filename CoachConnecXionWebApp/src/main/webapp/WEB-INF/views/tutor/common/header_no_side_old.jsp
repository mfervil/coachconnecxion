		...
		<header>
			...
			<nav>
				<ul id="menu">
					<li><a href="#">SEARCH</a>
						<ul>	
							<li><a href="${pageContext.request.contextPath}/tutor/userprofileList">FIND A COACH</a></li>
							<li><a href="${pageContext.request.contextPath}/tutor/information?type=so">SEARCH OVERVIEW</a></li>
							<li><a href="${pageContext.request.contextPath}/tutor/information?type=sf">FAQ</a></li>
						</ul>
					</li>
					<li><a href="blog-small.html">COACHES</a>
						<ul>	
							...
							<li><a href="${pageContext.request.contextPath}/tutor/packages?cuin=<%= SecurityUtils.getCurrentUser() == null?0:SecurityUtils.getCurrentUser().getId()%>">VIEW MY PACKAGES</a></li>
							<li><a href="${pageContext.request.contextPath}/tutor/post.html?cuin=<%= SecurityUtils.getCurrentUser() == null?0:SecurityUtils.getCurrentUser().getId()%>">VIEW REQUESTS</a></li>
							<li><a href="${pageContext.request.contextPath}/tutor/information?type=co">COACHING OVERVIEW</a></li>
							<li><a href="${pageContext.request.contextPath}/tutor/information?type=cf">FAQ</a></li>
						</ul>
					</li>
