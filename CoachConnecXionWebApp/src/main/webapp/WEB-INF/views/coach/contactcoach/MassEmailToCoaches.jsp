...
<%-- END BODY No Side test --%>
	...
	<div style="text-align: center; width: 900px; font-size: large; color: #00008B;">
		Contact Coach Network<br><br></div>
		...
		<tr>
			...
			<td>
				<div style="text-align: left;margin-left:10px;">
					...
					<form:form method="POST" id="contactcoach" commandName="contactcoach" >
						...
						<tr>
							...
							<br></form:errors><label>*What type of coaches are you looking for: &nbsp;</label> </td>
					    	<td class="leftalign">
						        <form:select size="1" path="category" id="category" >
						          <option value="-1">Select a Category</option>
						          ${contactcoach.category =='1' ? "<option selected value='1' >ADD / ADHD Coaches</option>" : "<option value='1' >ADD / ADHD Coaches</option>"}
						          ${contactcoach.category =='2' ? "<option selected  value='2' >Business Coaches</option>" : "<option value='2' >Business Coaches</option>"}
						          ${contactcoach.category =='3' ? "<option  selected value='3' >Career Upgrade Coaches</option>" : "<option value='3' >Career Upgrade Coaches</option>"}
						          ${contactcoach.category =='24' ? "<option  selected value='24' >College Prep. Testing Coaches</option>" : "<option value='24' >College Prep. Testing Coaches</option>"}
						          ${contactcoach.category =='5' ? "<option  selected value='5' >Diet / Nutrition / Weight Loss Coaches</option>" : "<option value='5' >Diet / Nutrition / Weight Loss Coaches</option>"}
						          ${contactcoach.category =='25' ? "<option  selected value='25' >Entrepreneurship Coaches</option>" : "<option value='25' >Entrepreneurship Coaches</option>"}
						          ${contactcoach.category =='14' ? "<option  selected value='14' >Executive / Management Coaches</option>" : "<option value='14' >Executive / Management Coaches</option>"}
						          ${contactcoach.category =='9' ? "<option  selected value='9' >Family Coaches</option>" : "<option value='9' >Family Coaches</option>"}
						          ${contactcoach.category =='10' ? "<option  selected value='10' >Finance / Money Coaches</option>" : "<option value='10' >Finance / Money Coaches</option>"}
						          ${contactcoach.category =='22' ? "<option  selected value='22' >Health / Fitness / Exercise Coaches</option>" : "<option value='22' >Health / Fitness / Exercise Coaches</option>"}
						          ${contactcoach.category =='12' ? "<option  selected value='12' >Leadership Coaches</option>" : "<option value='12' >Leadership Coaches</option>"}
						          ${contactcoach.category =='13' ? "<option  selected value='13' >Life Coaches</option>" : "<option value='13' >Life Coaches</option>"}
						          ${contactcoach.category =='16' ? "<option  selected value='16' >Performance / Motivational Coaches</option>" : "<option value='16' >Performance / Motivational Coaches</option>"}
						          ${contactcoach.category =='18' ? "<option  selected value='18' >Relationship / Couples Coaches</option>" : "<option value='18' >Relationship / Couples Coaches</option>"}
						          ${contactcoach.category =='20' ? "<option  selected value='20' >Sales Coaches" : "<option value='20' >Sales Coaches</option>"}
						          ${contactcoach.category =='23' ? "<option  selected value='23' >Team Building and Group Coaches</option>" : "<option value='23' >Team Building and Group Coaches</option>"}
						        </form:select>
					        </td>
						</tr>
						<tr><td>&nbsp;</td><td>&nbsp;</td></tr>
				...
				--%>		
					...
					coachcontactcoach.gradelevel =='a' ? "<option selected value='a'>Elementary (K - 6)</option>" : "<option value='a'>Elementary (K - 6)</option>"}
						...
						<td></td>
							<td style="text-align: left;"><input type="submit"
								...
								value="Send your requests to coaches" name="submit1" id="submit1" disabled colspan="2">
