...
<link href="css/webwidget_rating_bar.css" rel="stylesheet"
	type="text/css"></link>
						...
						<c:when test="${not empty successMessage}">
							<div id='myDialog'>
								<h1 style="font-size: 14px; color: green;">${successMessage}</h1>
								 <br>
								 <br>
								Click&nbsp;&nbsp;<a href="/Testing/jobRating" style="font-size: 14px;text-decoration: underline;color:blue;">here</a>&nbsp;&nbsp;To go back project list.							
...
<%@ include file="footer_no_side.jsp"%>