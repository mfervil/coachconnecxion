...
@Controller
@RequestMapping("/tutor/createcustomeruserprofilesuccess/userProfileId/{userProfileId}")
public class TutorCreateCustomerUserProfileSuccessController {
    private static final Logger log = LoggerFactory.getLogger(TutorCreateCustomerUserProfileSuccessController.class);
    ...
    public ModelAndView createBillPaySuccess(@PathVariable("userProfileId") String userProfileId, Model model) {
	    ...
	    try{	
	    	...
	    	return new ModelAndView("tutor/userprofile/createCustomerUserProfileSuccess", "model", myModel);
