...
public class JobRatingController {
	...
	@Autowired
	public JobRatingController(PaymentInformationManager paymentInformationManager,
	...
	@RequestMapping(value = "/feedbackAddNoOrder", method = RequestMethod.GET)
	public String getFeedbackAddNoOrder(
		...
		try{	
			...
			return "rating/FeedbackcommentsNoOrder";
		} catch (Exception e) {
	        String msg = "The request failed. Error " + e;
	        log.error(msg, e);
			model.addAttribute(Constants.ERROR_MSG_KEY, Constants.ERROR_MSG);
	...
	@RequestMapping(value = "/feedbackAddNoOrder", method = RequestMethod.POST)
