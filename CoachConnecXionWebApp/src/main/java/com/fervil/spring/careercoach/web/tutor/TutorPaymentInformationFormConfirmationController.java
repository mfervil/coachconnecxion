...
@Controller
@RequestMapping("/tutor/public/paymentinformationConfirmation")
public class TutorPaymentInformationFormConfirmationController  {
	
    private static final Logger log = LoggerFactory.getLogger(TutorPaymentInformationFormConfirmationController.class);
	...
	@Autowired
	public TutorPaymentInformationFormConfirmationController(PaymentInformationManager paymentInformationManager,
	...
	public ModelAndView showPaymentInformationForm(org.springframework.web.context.request.WebRequest webRequest, Model model) {
		...
		try{	
			...
			mav.setViewName ("tutor/public/paymentprocessing/paymentInformation");
		...
		try{
	        ...
	        if (result.hasErrors()) {
				...
				if (((String)request.getParameter("processPayment")).equalsIgnoreCase("processPaymentYes") ){
		    		...
		    		mav.setViewName ("tutor/public/paymentprocessing/paymentInformationConfirmation");
				}
			}
			return mav;
