...
@Controller
@RequestMapping("/public/coachSelection")
public class CoachSelectionFormController  {
	...
	@Autowired
	public CoachSelectionFormController(CoachSelectionManager coachSelectionManager,
