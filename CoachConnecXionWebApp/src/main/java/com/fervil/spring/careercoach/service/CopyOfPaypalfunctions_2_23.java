...
@Service
public class CopyOfPaypalfunctions_2_23  {
    private static final Logger logger = LoggerFactory.getLogger(CopyOfPaypalfunctions_2_23.class);
	
//TODO  This file needs to be cleaned up to remove all the System.out statements.
	
	
    private static final Logger log = LoggerFactory.getLogger(CopyOfPaypalfunctions_2_23.class);
    ...
    public CopyOfPaypalfunctions_2_23() throws Exception {//lhuynh - Actions to be Done on init of this class
...
/*********************************************************************************
	...
	*********************************************************************************/
public String ExecutePayment(String paymentType, String paymentAmount, String creditCardType, String creditCardNumber, String expMonth, String expYear, String cvv2, String firstName, String lastName, String street, String city, String state, String zip, String countryCode, String currencyCode, String orderdescription)  throws Exception 
{
    String RespMsg = "";
    String strRequestID = PayflowUtility.getRequestId();
    ...
    Currency amt = new Currency(new Double(paymentAmount), "USD");
    ...
    bill.setBillToCountry(countryCode);
    ...
    CreditCard cc = new CreditCard(creditCardNumber, expMonth + expYear);
    cc.setCvv2(cvv2);
        ...
        */
        ...
        if (TrxnResponse.getResult() < 0) { // Transaction failed.
            ...
            try {
                ...
                String msg = "Failed to send confirmation email for: " + paymentInformation.getEmail() + " Error " + e;
                paymentInformation.setEmail("Email Failled -- " + paymentInformation.getEmail() );
                log.error(msg, e);
            }
            
            //Log the transaction
            log.info(" Details of successfull payment:  " + paymentInformation.toString() + paymentInformation.getEmail() + paymentInformation.getPackageName() + paymentInformation.getPackagePrice());
