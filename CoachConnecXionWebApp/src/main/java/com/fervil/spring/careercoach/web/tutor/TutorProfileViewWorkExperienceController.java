...
@Transactional
@Controller
public class TutorProfileViewWorkExperienceController {
    private static final Logger log = LoggerFactory.getLogger(TutorProfileViewWorkExperienceController.class);
	...
	@RequestMapping(value = "/tutor/workexperience", method = RequestMethod.GET)
	public String getWorkexperience(Model model, org.springframework.web.context.request.WebRequest webRequest) {
		...
		try{
			...
			return "tutor/workexperience/WorkExperience";
	...
	@RequestMapping(value = "/tutor/addEditWorkExperience", method = RequestMethod.GET)
	public String getAddEditWorkExperience(Model model, org.springframework.web.context.request.WebRequest webRequest) {
		...
		try{
			model.addAttribute("profileId", Integer.valueOf(webRequest.getParameter("profileId")));
			return "tutor/workexperience/AddEditWorkExperience";
		} catch (Exception e) {
	        String msg = "The request failed. Error " + e;
	        log.error(msg, e);
			model.addAttribute(Constants.ERROR_MSG_KEY, Constants.ERROR_MSG);
	...
	@RequestMapping(value = "/tutor/experienceEdit", method = RequestMethod.GET)
	public String getExperienceEdit(
		...
		try{
			...
			return "tutor/workexperience/EditWorkExperience";
		} catch (Exception e) {
	        String msg = "The request failed. Error " + e;
	        log.error(msg, e);
			model.addAttribute(Constants.ERROR_MSG_KEY, Constants.ERROR_MSG);
	...
	@RequestMapping(value = "/tutor/experienceEdit", method = RequestMethod.POST)
	...
	@RequestMapping(value = "/tutor/jobhistoryAdd", method = RequestMethod.GET)
	public String getJobhistoryAdd(Model model, org.springframework.web.context.request.WebRequest webRequest) {
		try{
			...
			model.addAttribute("profileId", Integer.valueOf(webRequest.getParameter("profileId")));
			return "tutor/workexperience/AddWorkExperience";
		} catch (Exception e) {
	        String msg = "The request failed. Error " + e;
	        log.error(msg, e);
			model.addAttribute(Constants.ERROR_MSG_KEY, Constants.ERROR_MSG);
	...
	@RequestMapping(value = "/tutor/jobhistoryAdd", method = RequestMethod.POST)
	...
	@RequestMapping(value = "/tutor/profilejobhistoryAdd", method = RequestMethod.GET)
	public String getprofilejobhistoryAdd(Model model, org.springframework.web.context.request.WebRequest webRequest) {
		try{
			...
			return "tutor/profile/ProfileAddworkExperience";
		} catch (Exception e) {
	        String msg = "The request failed. Error " + e;
	        log.error(msg, e);
			model.addAttribute(Constants.ERROR_MSG_KEY, Constants.ERROR_MSG);
	...
	@RequestMapping(value = "/tutor/profilejobhistoryAdd", method = RequestMethod.POST)
	...
	@RequestMapping(value = "/tutor/experienceDelete", method = RequestMethod.GET)
