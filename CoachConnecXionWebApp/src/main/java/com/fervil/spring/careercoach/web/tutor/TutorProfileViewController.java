...
public class TutorProfileViewController {
    ...
    private static final Logger log = LoggerFactory.getLogger(TutorProfileViewController.class);
	...
	@RequestMapping(value = "/tutor/userprofile/systemUsageType", method = RequestMethod.GET)
	public String getUsageType(Model model, org.springframework.web.context.request.WebRequest webRequest, 
		...
		try{
			return "tutor/userprofile/systemUsageType";
		} catch (Exception e) {
	...
	@RequestMapping(value = "/tutor/public/createCustomerUserProfile", method = RequestMethod.GET)
	public String createCustomerUserProfile(Model model, org.springframework.web.context.request.WebRequest webRequest, 
		...
		try{
			...
			return "redirect:/tutor/createcustomeruserprofile";
	...
	@RequestMapping(value = "/tutor/public/profile", method = RequestMethod.GET)
	public String getProfile(Model model, org.springframework.web.context.request.WebRequest webRequest, 
		...
		try{	
			...
			if (webRequest.getParameter("BREADCRUMB") != null) {
				...
				if (webRequest.getParameter("cuin") == null){
					...
					if (profileId < 1){ //If no profile exists in the system for this user, send him/her to create a profile
						return "redirect:/tutor/createuserprofile";
					}
				}
			...
			return "tutor/public/profile/ProfileOverview";
		} catch (Exception e) {
	...
	@RequestMapping(value = "/tutor/public/coachprofile/profileId/{profileId}", method = RequestMethod.GET)
...
*/
	@RequestMapping(value = "/tutor/remove1", method = RequestMethod.GET)
	public String remove1(
		...
		try {
			...
			List<Experiencedetails> jobHostoryAttribute = addWorkExperienceService
					.getAllexperiences();
			model.addAttribute("tutor/jobHostoryAttribute", jobHostoryAttribute);
			return "tutor/public/profile/ProfileOverview";
		} catch (Exception e) {
	        String msg = "The request failed. Error " + e;
	        log.error(msg, e);
...
*/
	...
	@RequestMapping(value = "/tutor/displayImage", method = RequestMethod.GET)
