...
public class TutorPackageController {
    private static final Logger log = LoggerFactory.getLogger(TutorPackageController.class);
	...
	@RequestMapping(value = "/tutor/packages", method = RequestMethod.GET)
	public String getPackages(Model model, HttpServletRequest request, 
		...
		try{	
			...
			model.addAttribute("userProfileId", userProfileId);
			return "tutor/package/accountsummarymyPackages";
		} catch (Exception e) {
	...
	@RequestMapping(value = "/tutor/packagesCurrentUser", method = RequestMethod.GET)
	...
	@RequestMapping(value = "/tutor/packageAdd", method = RequestMethod.GET)
	public String getPackageAdd(Model model, HttpServletRequest request, HttpSession session) {
		...
		try{	
			...
			return "tutor/package/createPackage";
	...
	@RequestMapping(value = "/tutor/packageAdd", method = RequestMethod.POST)
	...
	@RequestMapping(value = "/tutor/packages", method = RequestMethod.POST)
	...
	@RequestMapping(value = "/tutor/AddUser.htm", method = RequestMethod.GET)
	public @ResponseBody
...
//TODO Need to catch the exceptions for this page....			
	...
	@RequestMapping(value = "/tutor/packageEdit", method = RequestMethod.GET)
	public String getPackageEdit(
		...
		try{	
			...
			*/
			...
			return "tutor/package/editPackage";
	...
	@RequestMapping(value = "/tutor/packageEdit", method = RequestMethod.POST)
	...
	@RequestMapping(value = "/tutor/packagedelete", method = RequestMethod.GET)
