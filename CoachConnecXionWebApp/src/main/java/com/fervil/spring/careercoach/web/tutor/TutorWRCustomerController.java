...
@Scope("session")
@Controller
public class TutorWRCustomerController {
    private static final Logger log = LoggerFactory.getLogger(TutorWRCustomerController.class);
...
/*	
	...
	@Autowired
	public WRCustomerController(UserProfileManager userProfileManager,
...
*/	
	...
	@RequestMapping(value = "/tutor/workroom/wrsendMail", method = RequestMethod.GET)
	public ModelAndView sendMail(@ModelAttribute("command")  CustomerBean customerbean,
		...
		try{
			...
			return new ModelAndView("tutor/workroom/wrindex");
		} catch (Exception e) {
			...
			return new ModelAndView("tutor/public/common/error/errorpage", model);
...
*/	
	...
	@RequestMapping(value = "/tutor/workroom/wrsearch", method = RequestMethod.POST)
	public ModelAndView search(@ModelAttribute("command")  CustomerBean customerbean,
		...
		try{
			...
			model.put("listdownload",listdownload);
			return new ModelAndView("tutor/workroom/wrWelcome", model);
...
*/		
	...
	//Send Message Tanumoy da.....
		...
		@RequestMapping(value = "/tutor/workroom/wrsendMessage", method = RequestMethod.GET)
		public ModelAndView  sendMessage(org.springframework.web.context.request.WebRequest webRequest, HttpServletRequest request) {
			...
			try{
				...
				*/
				...
				return new ModelAndView("tutor/workroom/wrEmailForm", model); 
		...
		@RequestMapping(value = "/tutor/workroom/wrloadMessageDetails", method = RequestMethod.GET)
