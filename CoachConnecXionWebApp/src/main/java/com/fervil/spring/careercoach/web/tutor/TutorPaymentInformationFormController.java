...
@Controller
@RequestMapping("/tutor/public/paymentinformation")
public class TutorPaymentInformationFormController  {
	
    private static final Logger log = LoggerFactory.getLogger(TutorPaymentInformationFormController.class);
	...
	@Autowired
	public TutorPaymentInformationFormController(PaymentInformationManager paymentInformationManager,
