...
@Controller
@RequestMapping("/tutor/workroom/wrsendEmail")
public class TutorWRSendEmailAttachController { 
	
    private static final Logger log = LoggerFactory.getLogger(TutorWRSendEmailAttachController.class);
