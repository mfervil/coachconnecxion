...
@Controller		  
public class TutorsiteInfoController {
    private static final Logger log = LoggerFactory.getLogger(TutorsiteInfoController.class);
...
@RequestMapping(value = "/tutor/how-it-works", method = RequestMethod.GET)
public ModelAndView getHowItWorks(HttpServletRequest request, HttpServletResponse response, Model model) {
	...
	try{	
		...
		String now = (new java.util.Date()).toString();
        myModel.put("now", now);
		String navPage = "tutor/public/common/systeminfo/howitworks";
	...
	@RequestMapping(value = "/tutor/about-us", method = RequestMethod.GET)
    public ModelAndView getAboutUs(HttpServletRequest request, HttpServletResponse response, Model model) {
    	...
    	try{	
    		...
    		String now = (new java.util.Date()).toString();
	        myModel.put("now", now);
			String navPage = "tutor/public/common/systeminfo/aboutus";
	...
	@RequestMapping(value = "/tutor/contact-us", method = RequestMethod.GET)
    public ModelAndView getContactUs(HttpServletRequest request, HttpServletResponse response, Model model) {
    	...
    	try{	
    		...
    		String now = (new java.util.Date()).toString();
	        myModel.put("now", now);
			String navPage = "tutor/public/common/systeminfo/contactus";
	...
	@RequestMapping(value = "/tutor/terms-of-use", method = RequestMethod.GET)
    public ModelAndView getTermsOfUse(HttpServletRequest request, HttpServletResponse response, Model model) {
    	...
    	try{	
    		...
    		String now = (new java.util.Date()).toString();
	        myModel.put("now", now);
			String navPage = "tutor/public/common/legal/termsofuse";
	...
	@RequestMapping(value = "/tutor/privacy-policy", method = RequestMethod.GET)
    public ModelAndView getPrivacyPolicy(HttpServletRequest request, HttpServletResponse response, Model model) {
    	...
    	try{	
    		...
    		String now = (new java.util.Date()).toString();
	        myModel.put("now", now);
			String navPage = "tutor/public/common/legal/privacypolicy";
	...
	@RequestMapping(value = "/tutor/safety-tips", method = RequestMethod.GET)
    public ModelAndView getSafetyTips(HttpServletRequest request, HttpServletResponse response, Model model) {
    	...
    	try{	
    		...
    		String now = (new java.util.Date()).toString();
	        myModel.put("now", now);
			String navPage = "tutor/public/common/legal/personalsafety";
