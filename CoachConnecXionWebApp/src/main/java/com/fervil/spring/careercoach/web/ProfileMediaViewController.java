...
public class ProfileMediaViewController {
    private static final Logger log = LoggerFactory.getLogger(ProfileMediaViewController.class);
	
	@Autowired
	private SessionFactory sessionFactory;

/***********************Remove This hardcoded ID below *************************************************/	
	//int customerId=1;
/***********************Remove This hardcoded ID above *************************************************/	
	...
	@RequestMapping(value = "/addProfileMedia", method = RequestMethod.GET)
	public String getProfileMediaById(Model model, org.springframework.web.context.request.WebRequest webRequest) {
		...
		try{	
			...
			return "profile/AddProfileMediaInfo";
	...
	@RequestMapping(value = "/addProfileMedia", method = RequestMethod.POST)
	public String saveImage(
 		...
 		try {
			...
			if (errorValid == true) {
				...
				return "profile/AddProfileMedia";
