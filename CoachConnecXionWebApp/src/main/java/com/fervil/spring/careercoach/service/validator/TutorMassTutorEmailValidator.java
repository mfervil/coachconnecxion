...
@Service("massTutorContactValidator")
@Component
public class TutorMassTutorEmailValidator implements Validator {
    private static final Logger logger = LoggerFactory.getLogger(TutorMassTutorEmailValidator.class);
