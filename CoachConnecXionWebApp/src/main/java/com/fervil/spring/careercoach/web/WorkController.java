...
Integer requestId=1;
	...
	@RequestMapping(value = "/public/selectCoachingCategories", method = RequestMethod.GET)
	public String getSelectCoachingCategories(Model model) {
		...
		try{	
			...
			return "public/findcoach/SelectCoachingCategories";
		} catch (Exception e) {
	...
	@RequestMapping(value = "/public/Allrequests", method = RequestMethod.GET)
	public String getAllRequests(Model model,HttpServletRequest request) {
		...
		try{
			...
			model.addAttribute("coachingCategory", coachingCategory);
			return "public/findcoach/AllRequests";
		} catch (Exception e) {
	        String msg = "The request failed. Error " + e;
	        log.error(msg, e);
			model.addAttribute(Constants.ERROR_MSG_KEY, Constants.ERROR_MSG);
	...
	@RequestMapping(value = "/public/requestNames", method = RequestMethod.GET)
	public String getRequestNames(
		...
		try{
			...
			return "public/findcoach/RequestNames";
		} catch (Exception e) {
	        String msg = "The request failed. Error " + e;
	        log.error(msg, e);
			model.addAttribute(Constants.ERROR_MSG_KEY, Constants.ERROR_MSG);
	...
	@RequestMapping(value = "/public/requestNames", method = RequestMethod.POST)
	...
	@RequestMapping(value = "/public/Executiverequests", method = RequestMethod.GET)
	public String getExecutiverequests(Model model) {
		log.debug("Received request to show all persons");
		try{
			List<RequestDetails> requestDetails = requestDetailService.getAll();
			model.addAttribute("requestDetails", requestDetails);
			return "public/findcoach/ExecutiveRequest";
		} catch (Exception e) {
	        String msg = "The request failed. Error " + e;
	        log.error(msg, e);
			model.addAttribute(Constants.ERROR_MSG_KEY, Constants.ERROR_MSG);
	...
	@RequestMapping(value = "/public/BusinessExecutive", method = RequestMethod.GET)
	public String getBusinessExecutive(Model model) {
		log.debug("Received request to show all persons");
		try{
			List<RequestDetails> requestDetails = requestDetailService.getAll();
			model.addAttribute("requestDetails", requestDetails);
			return "public/findcoach/BusinessExecutive";
		} catch (Exception e) {
	        String msg = "The request failed. Error " + e;
	        log.error(msg, e);
			model.addAttribute(Constants.ERROR_MSG_KEY, Constants.ERROR_MSG);
	...
	@RequestMapping(value = "/public/BusinessManager", method = RequestMethod.GET)
	public String getBusinessManager(Model model) {
		log.debug("Received request to show all persons");
		try{
			List<RequestDetails> requestDetails = requestDetailService.getAll();
			model.addAttribute("requestDetails", requestDetails);
			return "public/findcoach/BusinessManager";
		} catch (Exception e) {
	        String msg = "The request failed. Error " + e;
	        log.error(msg, e);
			model.addAttribute(Constants.ERROR_MSG_KEY, Constants.ERROR_MSG);
	...
	@RequestMapping(value = "/public/BusinessNewBusiness", method = RequestMethod.GET)
	public String getBusinessNewBusiness(Model model) {
		log.debug("Received request to show all persons");
		try{
			List<RequestDetails> requestDetails = requestDetailService.getAll();
			model.addAttribute("requestDetails", requestDetails);
			return "public/findcoach/BusinessNewBusiness";
		} catch (Exception e) {
	        String msg = "The request failed. Error " + e;
	        log.error(msg, e);
			model.addAttribute(Constants.ERROR_MSG_KEY, Constants.ERROR_MSG);
	...
	@RequestMapping(value = "/public/getRequestDetails", method = RequestMethod.GET)
	...
	@RequestMapping(value = "/public/getRequestDetails1", method = RequestMethod.GET)
