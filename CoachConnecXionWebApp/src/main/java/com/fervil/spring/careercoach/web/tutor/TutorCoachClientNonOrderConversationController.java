...
@Controller
public class TutorCoachClientNonOrderConversationController {
    private static final Logger log = LoggerFactory.getLogger(TutorCoachClientNonOrderConversationController.class);
	...
	@Autowired
	public TutorCoachClientNonOrderConversationController(PaymentInformationManager paymentInformationManager,
	...
	@RequestMapping(value = "/tutor/workroom/wrsendMessageNoOrder", method = RequestMethod.GET)
