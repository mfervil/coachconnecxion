...
@Transactional
@Controller
public class TutorProfileViewEducationController {

    private static final Logger log = LoggerFactory.getLogger(TutorProfileViewEducationController.class);
	...
	@RequestMapping(value = "/tutor/education", method = RequestMethod.GET)
	public String getEducation(Model model, org.springframework.web.context.request.WebRequest webRequest) {
		...
		try{
			...
			return "tutor/education/Education";
		} catch (Exception e) {
	...
	@RequestMapping(value = "/tutor/educationAdd", method = RequestMethod.GET)
	public String getEducationAdd(Model model, org.springframework.web.context.request.WebRequest webRequest) {
		...
		model.addAttribute("profileId", Integer.valueOf(webRequest.getParameter("profileId")));
		try{
			return "tutor/education/AddEducation";
		} catch (Exception e) {
	        String msg = "The request failed. Error " + e;
	        log.error(msg, e);
			model.addAttribute(Constants.ERROR_MSG_KEY, Constants.ERROR_MSG);
	...
	@RequestMapping(value = "/tutor/educationAdd", method = RequestMethod.POST)
	...
	@RequestMapping(value = "/tutor/educationEdit", method = RequestMethod.GET)
	public String getEducationEdit(
		...
		try{
			...
			return "tutor/education/EditEducation";
		} catch (Exception e) {
	        String msg = "The request failed. Error " + e;
	        log.error(msg, e);
			model.addAttribute(Constants.ERROR_MSG_KEY, Constants.ERROR_MSG);
	...
	@RequestMapping(value = "/tutor/educationEdit", method = RequestMethod.POST)
	...
	@RequestMapping(value = "/tutor/profileeducationAdd", method = RequestMethod.GET)
	public String getProfileeducationAdd(Model model, org.springframework.web.context.request.WebRequest webRequest) {
		try{
			model.addAttribute("educationAttribute", new EducationDetails());
			model.addAttribute("profileId", Integer.valueOf(webRequest.getParameter("profileId")));
			
			return "tutor/profile/ProfileAddEducation";
		} catch (Exception e) {
	        String msg = "The request failed. Error " + e;
	        log.error(msg, e);
			model.addAttribute(Constants.ERROR_MSG_KEY, Constants.ERROR_MSG);
	...
	@RequestMapping(value = "/tutor/profileeducationAdd", method = RequestMethod.POST)
	...
	@RequestMapping(value = "/tutor/educationDelete", method = RequestMethod.GET)
