...
<%@ include file="/WEB-INF/views/userprofile/include.jsp" %>
<!-- PACKAGE  FORM -->
<html>
<head>
...
<body onload="myFunction();">
	...
	<form:form modelAttribute="packageAttribute" method="POST" id="createPackageForm"
		action="${saveUrl}">
		<table style="border: none; width: 900px; text-align: center">
			...
			<tr style="text-align: left;">
				...
				<td style="text-align: left; width: 150px;"><input
					type="submit" value="Submit" name="submit1" id="submit1"
	...
	<table
		...
		<tr>
			<td><c:url var="cancelUrl" value="/packages" /> <form:form
